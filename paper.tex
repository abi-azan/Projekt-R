...
\begin{table}[htbp]
\centering
\caption{Events by announcement year with regular/irregular split (stock-event pairs).}
\label{tab:events_by_year}
\scriptsize
\begin{tabular}{rrrrrrr}
\toprule
Year & Ins. & Del. & Reg. Ins. & Irr. Ins. & Reg. Del. & Irr. Del. \\
\midrule
2010 & 3 & 3 & 3 & 0 & 3 & 0 \\
2011 & 7 & 7 & 7 & 0 & 7 & 0 \\
2012 & 5 & 5 & 5 & 0 & 5 & 0 \\
...
\section{Results}
Table~\ref{tab:data_overview} and Table~\ref{tab:events_by_year} report the sample composition and the regular/irregular split by year. Insertions and deletions are of similar size, with slightly more deletion events.
...
\item Split insertions/deletions and regular/irregular updates; manually corrected labels where ZSE formatting was inconsistent.
...
\item Excluded the DDJH deletion on 2022-07-14 from CAR analysis as an outlier.
\end{itemize}
